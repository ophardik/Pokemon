...
//     try {
//       const response = await axios.get(`/api/specificPokemon?name=${pokemonName}`);
...
//       {/* 🛡️ Strength & Weakness Section in Bottom-Right */}
//       <div className="moves-container">
//   <h3 className="moves-title">Moves</h3>
//   <div className="moves-list">
//     {pokemon.moves && pokemon.moves.length > 0 ? (
//       pokemon.moves.slice(0, 6).map((move, index) => (  // Limit to 6 moves
//         <div key={index} className="move-item">
//           {move.move.name.toUpperCase()} {/* Assuming each move has a 'move' object with 'name' */}
//         </div>
//       ))
//     ) : (
//       <p>No moves available</p> // If there are no moves, show this message
//     )}
//   </div>
// </div>
